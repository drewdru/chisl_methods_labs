...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_2->addLayout(horizontalLayout_9, 0, 8, 1, 1);
        ...
        gridLayout_2->addLayout(horizontalLayout_8, 0, 4, 1, 1);
        ...
        gridLayout_2->addLayout(horizontalLayout_3, 1, 0, 1, 12);
        ...
        gridLayout_2->addLayout(horizontalLayout_6, 0, 3, 1, 1);
        ...
        gridLayout_2->addWidget(spinBox, 0, 7, 1, 1);

        doubleSpinBox_5 = new QDoubleSpinBox(groupBox);
        doubleSpinBox_5->setObjectName(QStringLiteral("doubleSpinBox_5"));
        doubleSpinBox_5->setValue(0.1);

        gridLayout_2->addWidget(doubleSpinBox_5, 0, 10, 1, 1);
        ...
        menuBar->setGeometry(QRect(0, 0, 896, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "a = x0 =", 0));
    } // retranslateUi
