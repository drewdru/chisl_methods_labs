...
#include "../chisl_metod_lab4_1/help.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Help_t, stringdata) + ofs \
...
const QMetaObject Help::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Help.data,
      qt_meta_data_Help,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Help.stringdata))
